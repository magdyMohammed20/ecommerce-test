...
const ChartStats = () => {
  ...
  return (
    <div className="bg-white rounded-md   overflow-hidden">
      <div className="p-[16px] md:p-[24px]  text-gray-700">
        <div>
          <h1 className="text-[16px] font-[700] md:text-[20px] font-extrabold mb-6">
            {t("month earn")}{" "}
          </h1>
        ...
        <div
          className={`transform ${
            useLocale() == "ar"
              ? "translate-x-7 md:translate-x-0"
              : `${
        ...
        <div className="bg-gray-100 p-[16px] rounded-[10px] flex items-center gap-1 mt-5">
          <h3 className="text-sm lg:text-xl text-gray-600"> {t("earn")} : </h3>
          <span className="text-lg lg:text-[21px] font-extrabold">$500</span>
        </div>
      </div>
    </div>
  );
