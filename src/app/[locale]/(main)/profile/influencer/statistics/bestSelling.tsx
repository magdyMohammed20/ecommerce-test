...
const BestSelling = ({ documentWidth }: Props) => {
  ...
  return (
    <div className="bg-white overflow-hidden rounded-xl p-[16px] sm:p-[24px] flex flex-col gap-6 ">
      ...
      {/*
        ...
        */}
      <div
        className={`grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5  gap-[8px]  md:gap-[16px]`}>
        {firstRow}

        {documentWidth >= 768 && secondCard}

        {documentWidth >= 1024 && thirdCard}
      </div>
    </div>
  );
};
