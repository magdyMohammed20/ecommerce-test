...
const GenderChart = () => {
  ...
  var options: OptionsTypes = {
    ...
    xaxis: {
      ...
      categories:
        useLocale() == "en"
          ? ["perfumes", "sports bags", "makeup", "accessories", "sport shoes"]
          : ["عطور", "شنط رياضية", "مكياج", "اكسسوارات", "احذية رياضية"],
      labels: {
        style: {
          fontSize: "14px",
          fontWeight: 400,
  ...
  return (
    <div
      className="bg-white rounded-[12px] xl:flex-b  xl:basis-full  self-stretch   overflow-hidden p-[16px] md:p-[24px] xl:order-3
    ">
...
">
            <div className=" text-[10] font-[700] flex flex-col items-center gap-y-[4px]">
              <span className="w-[10px] h-[10px] bg-primary rounded-full block"></span>
