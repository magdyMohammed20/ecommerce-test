            ...
            <div className="flex justify-between w-full items-end">
              ...
              <div className="relative">
                ...
                <div className="absolute w-full flex flex-col items-center justify-center gap-1 inset-0 mb-1">
                  ...
                  />
                  <p className="text-asphalt text-xs md:text-sm font-bold">4%</p>
                </div>
              </div>
              <div className="relative">
                <UnionSecondary />
                <div className="absolute w-full flex flex-col items-center justify-center gap-1 inset-0 mb-1">
                  <Image
                    ...
                    className="w-4 md:w-[27px] h-4 md:h-[18px] object-cover"
                  />
                  <p className="text-asphalt text-xs md:text-sm font-bold">3%</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex w-full justify-between">
              {data.map((item) => (
                <div key={item.id} className="flex flex-col text-asphalt">
                  <p className="opacity-70 text-xs md:text-sm">{t(item.name)}</p>
